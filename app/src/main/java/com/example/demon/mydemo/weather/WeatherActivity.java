package com.example.demon.mydemo.weather;
...
import com.example.demon.mydemo.weather.gson.Forecast;
import com.example.demon.mydemo.weather.gson.Weather;
import com.example.demon.mydemo.weather.servive.AutoUpdateService;
import com.example.demon.mydemo.weather.util.Utility;
...
public class WeatherActivity extends AppCompatActivity {
    public DrawerLayout drawerLayout;       // 滑动窗口
    public SwipeRefreshLayout swipeRefresh; // 手动刷新

    private ScrollView weatherLayout;
    private Button navButton;               // 选测城市的按钮
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=" + Utility.WEATHERID;
